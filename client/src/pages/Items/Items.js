  ...
  render() {
    return <Container fluid>
        <div id="items-main">
          ...
          <Row>
            <Col size="md-4">
              <img src={packageImg} alt="care kit" data-aos={"flip-up"} data-aos-offset={200} data-aos-duration="600" data-aos-once={true} style={{ maxWidth: "100%", minHeight: "30rem", borderTop: "3px solid rgb(90,90,90)", borderBottom: "3px solid rgb(90,90,90)", borderRight: "3px solid rgb(90,90,90)", borderLeft: "3px solid rgb(90,90,90)", marginBottom: "5%" }
                  // borderLeft: "3px solid rgb(54, 54, 54)"
                } />
            </Col>
            <Col size="md-8">
              <div className="p-a">
                <p id="kit-title" style={{ fontSize: "2.5rem"}}>La Mama Care Signature Care Kit</p>
                {/* <p>
                  $45
                </p> */}
                {/* <FlatButton
                ...
                <p style={{ paddingRight: "15%" }}>
                  ...
                  mother with must-have items to help navigate the crucial
                  4th trimester. Also included is a La Mama Care resource
                  book filled with helpful information.
                </p>
