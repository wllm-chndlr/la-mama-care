      ...
      <Row>
        <Col size="md-12">
          <div className="p-a">
            ...
            other practical essentials, our kits are intended to surround the
            mother with must-have items and helpful information to help navigate
            the critical 4th trimester. In addition, we use a unique approach to
            bring together the mom’s support system to ensure everyone is
            working together to provide the comfort and encouragement the mom
            needs.
          </div>
        </Col>
      </Row>
        ...
        <Col size="md-12">
          <div className="p-a" id="included">
            ...
            <p>
              ...
              purchase additional supplies, as well as other available options
